...
import '../../assets/css/miscellaneous/toggle-theme.css';

const ThemeToggle: React.FC<PropsFromRedux> = props => {
  ...
  useEffect(() => {
    ...
    element?.addEventListener('change', toggleTheme)

    return () => {
      element?.removeEventListener('change', toggleTheme);
    }
  }, [inputRef, props]);

  return (
    <div className="toggle-theme">
      <input type="checkbox" ref={inputRef} id="check" />
      <label htmlFor="check" className="label">
        <svg version="1.1" id="Layer_1" xmlns="&ns_svg;" width="300" height="300" viewBox="0 0 300 300">
